...
public final class ThreadPoolBuilder implements Builder<ThreadPoolExecutor> {
    ...
    public ThreadPoolExecutor build() {
        if (threadFactory == null) {
            ...
            threadFactory = com.grace.train12306.framework.starter.common.threadpool.build.ThreadFactoryBuilder.builder().prefix(threadNamePrefix).daemon(isDaemon).build();
        }
